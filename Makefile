...
#    Updated: 2019/05/26 10:32:47 by phtruong         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
DEFAULT:=\033[39m
BLACK:=\033[30m
...
src :=	ft_putstr.c ft_putstr_fd.c ft_strlen.c ft_putchar.c ft_putchar_fd.c ft_strchr.c \
		...
		print_unbr_size_1.c print_unbr_size_2.c print_unbr_util_1.c print_unbr_driver.c print_string.c print_collector.c main.c
no_files := $(words ${src})
obj := ${src:.c=.o}
HEADER := NO
X := 1
